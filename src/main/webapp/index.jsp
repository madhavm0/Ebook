...
<body>
	...
	<div class="fluid-container back-img">
	...
	<div class="container">
			...
			<div class="col-md-3">
				<div class="card" style="width: 20vw;">
					<div class="card-body text-center">
						<img alt="Recent Book"
							src="https://m.media-amazon.com/images/I/81BROimNPvL.jpg"
							style="height: 30vh; width: 13vw;" class="img-thumblin">
						<p>Java Programming</p>
						<p>Wiley</p>
						<p>Categories:New</p>
						<div class="column">
							<a href="#" class="btn btn-primary btn-sm">Add Cart</a> <a
								href="#" class="btn btn-danger btn-sm ml-1">View Details</a> <a
								href="#" class="btn btn-success btn-sm ml-1">299</a>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="text-center mt-2">
			<a href="#" class="btn btn-danger btn-sm text-center">View All</a>
		</div>
	</div>
	<hr>
	<div class="container">
			...
			<div class="col-md-3">
				<div class="card" style="width: 20vw;">
					<div class="card-body text-center">
						...
						<p>Categories:New</p>
						<div class="column">
							<a href="#" class="btn btn-danger btn-sm ml-1">View Details</a> <a
								href="#" class="btn btn-success btn-sm ml-1">299</a>
						</div>
					</div>
				</div>
